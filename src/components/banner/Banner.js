...
import {FaLinkedinIn,FaReact,FaFacebook,FaInstagram} from "react-icons/fa"
...
const Banner = () => {
  ...
  return (
    <section id="home" className="w-full py-20 pb-20 flex flex-col lgl:flex-row items-center border-b-[1px] border-b-black font-titleFont">
     <div className="w-1/2" flex flex-col gap-20>
      <div className='flex flex-col gap-5'>
        <h4 className="text-2xl font-normal py-6">WELCOME TO MY WORLD</h4>
        <h1 className="text-8xl font-bold text-white">{" "}Hi, I'm{" "}
      ...
      <div className='flex flex-col lgl:flex-row justify-between' >
        <div>
        <h2 className='text-base font-bold uppercase font-titleFont mb-4 my-8'>Find Me In</h2>
  ...
  <a href="https://www.instagram.com/jatin_______/" target="_blank" rel="noopener noreferrer" className="bannerIcon">
    <FaInstagram />
        ...
        <div>
        <h2 className='text-base font-bold uppercase font-titleFont mb-4 my-8'>Best Skill On</h2>
      <div className="flex gap-4">
